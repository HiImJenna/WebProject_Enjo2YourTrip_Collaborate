	...
	<div class="list-gathering-detail">
      ...
      <iconify-icon icon="bx:arrow-back" width="30" height="30"></iconify-icon>
		...
		<div class="culture-sub-heading-container">
			<span class="culture-sub-heading">문의글 수정하기</span>
		</div>
			...
			<div class="list-summary-top">
				<div class="person-information post-gap">
					...
					<div class="nickname-date">
						<span class="nickname"><b>${requestScope.writer}</b></span>
					</div>
				</div>
			</div>
			<div class="post">

			 	<form name="noticeEditOk" id="gathering-form" action="${pageContext.request.contextPath}/qnaEditOk.do" method="POST">
					...
					<textarea  style="resize: none;" name="content" form="gathering-form" cols="300" rows="25" maxlength="" class="post-gap">${requestScope.content}</textarea>
					<div class="right">
