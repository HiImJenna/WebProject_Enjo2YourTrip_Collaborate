			...
			<div class="list-summary-top">
				<div class="person-information post-gap">
					...
					<div class="nickname-date">
						<span class="nickname"><b>${requestScope.nickName} 님</b></span>
					</div>
				</div>
			</div>
			<div class="post">
				<form name="bw" id="gathering-form" action="${pageContext.request.contextPath}/anaWriteOk.do" method="POST">
					...
					<textarea style="resize: none;" name="content"form="gathering-form" cols="135" rows="25" maxlength="" class="post-gap"></textarea>
					<div class="right">
