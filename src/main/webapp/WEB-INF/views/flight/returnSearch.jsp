...
<div class="maincontent overlay ">
    ...
    <div class="flightList container">
      <div class="choosehead text-center">
        <h2 style = "color: #f38375; "><b>제주-김포행 비행기를 선택해주세요!</b></h2>             
      </div>
	          ...
	          success: function (responsetext) {//응답이 왔고 .. 그 응답이 정상건이라면 자동호출 콜백
	              ...
	              for(let i = 0; i < list.length; ++i) {
	        		...
	        		*/
	                ...
	                let tempHtml = `
	                				<form class="row flight 4563" name = "flightList" action="flightCheck.flight" method="GET">
		                	
		                				<div class="air-container">
		                					<div class="col-sm-2">
		                				  	  <input type = "text" name = "eairlineNm" value = \${item.airlineNm} readonly style = "background: transparent; text-align:center; font-size: 22px;">
		                					</div>
		                					
		                					<div class="col-sm-2">
		                				   	 <input type = "text" name = "edepAirportNm" value = \${item.depAirportNm} readonly style = "background: transparent; text-align:center; font-size: 22px;">
		                				   	</div>
		                				   	
		                				   	<div class="col-sm-2">
		                				   	 <input type = "text" name = "earrAirportNm" value = \${item.arrAirportNm} readonly style = "background: transparent; text-align:center; font-size: 22px;">
		                				   	</div>
		                				   	
		                				   	<div class="col-sm-2">
		                				   	 <input type = "text" name = "edepPlandTime" value = \${dep} readonly style = "background: transparent; text-align:center; font-size: 22px;">
		                				   	</div>
		                				   	
		                				   	<div class="col-sm-2">
		                				    	<input type = "text" name = "earrPlandTime" value = \${arr} readonly style = "background: transparent; text-align:center; font-size: 22px; ">
		                				    </div>
		                				    
		                				    <div class="col-sm-2">
		                				   	 	<input type = "text" name = "eprice" value = \${price}원 readonly style = "background: transparent; text-align:center; font-size: 22px; color: red;">
		                				   	</div>
